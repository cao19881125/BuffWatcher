...
do
	local widgetType = "Dropdown-Pullout2"
...
do
	...
	local function SetLabel(self, text)
		if text and text ~= "" then
			...
			self.label:Show()
			self.dropdown:SetPoint("TOPLEFT",self.frame,"TOPLEFT",25,5)
			self:SetHeight(25)
			self.alignoffset = 26
		else
			self.label:SetText("")
	...
	local function Constructor()
		...
		label:Hide()
		self.label = label
		Font, Height, Flags = label:GetFont()
    	label:SetFont(Font, 12, Flags)
